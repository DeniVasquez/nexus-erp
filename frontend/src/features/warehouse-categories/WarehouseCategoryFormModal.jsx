...
function WarehouseCategoryFormModal(props) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isEditing()) {
        await warehouseCategoriesApi.update(props.category._id, payload);
        showToast.success("Categoría actualizada correctamente");
      } else {
        await warehouseCategoriesApi.create(payload);
...
export default WarehouseCategoryFormModal;
