...
function SubCategoryHistoryModal(props) {
  const [history] = createResource(
    () => props.subCategory,
    async (subCategory) => {
      if (!subCategory) return null;
      return subCategoriesApi.getHistory(subCategory._id);
    },
  );
        ...
        <div class="flex-1 overflow-y-auto p-6">
          ...
          <Show when={history() && history().data}>
            <Show
              ...
              fallback={
                <div class="text-center py-8 text-gray-500 dark:text-gray-400">
                  No hay cambios registrados para esta sub-categoría
                </div>
              }
            >
              <div class="space-y-4">
...
export default SubCategoryHistoryModal;
